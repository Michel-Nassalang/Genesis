...
BottomNavigationBar buildBottomNavigationBar() {
    return BottomNavigationBar(
      ...
      items: const [
        BottomNavigationBarItem(icon: Icon(Icons.message_outlined), label: "Chats", tooltip:"Messages"),
        BottomNavigationBarItem(icon: Icon(Icons.people), label: "People", tooltip:"People"),
        BottomNavigationBarItem(icon: Icon(Icons.call), label: "Appels", tooltip:"Appels"),
        BottomNavigationBarItem(icon: CircleAvatar(radius: 14,backgroundImage: AssetImage("assets/genesis_flex.jpg"),),
          label: "Profil",
          tooltip: "Profil",
        ),
      ],
